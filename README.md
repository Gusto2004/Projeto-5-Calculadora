...
Calculadora simples com as quatro operações básicas, feita em JavaScript puro. Primeiro projeto construído de forma autónoma, como exercício de consolidação.

## Funcionalidades

- Somar, subtrair, multiplicar e dividir dois números
- Suporte a números decimais
- Modo escuro / claro com botão de alternância (começa em modo escuro)
...
- [ ] Permitir cálculos com o teclado (tecla Enter para calcular)
